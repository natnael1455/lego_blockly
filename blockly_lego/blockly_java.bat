...
java -Djava.library.path="%LEJOS_HOME%\bin" -classpath "%LINK_CLASSPATH%" js.tools.LejosLinkAndDownload --writeorder BE --classpath "%LINK_CLASSPATH%" -tty %RCXTTY% Lego_rcx_code
